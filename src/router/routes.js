...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'scrap-data', name: 'dashboard-scrap-data', component: () => import('src/pages/Admin/ScrapData') },
      ...
      { path: 'regions', name: 'dashboard-regions', component: () => import('src/pages/Admin/Regions') },
      { path: 'countries', name: 'dashboard-countries', component: () => import('src/pages/Admin/Countries') },
    ],
  },
  {
    path: '/login',
